...
class patient_site_appointment_detai extends React.Component {
  ...
  submit = () => {
    Actions.Doctor_registration_C3()
  }
          ...
          <ProgressSteps disabledStepNumColor='#186ADE' activeStepNumColor='#186ADE' activeStepIconBorderColor='#3085F4' activeStepIconColor='#D6E7FD' progressBarColor='#D6E7FD' completedStepIconColor='#3085F4' completedProgressBarColor='#3085F4' disabledStepIconColor='#D6E7FD' >
            ...
            <ProgressStep label="" nextBtnStyle={styles.next_button} nextBtnTextStyle={styles.next_text}>
              ...
              <View style={{ width: width / 1.1, alignSelf: 'center', borderRadius: 10, marginTop: 10 }}>
                ...
                <Text style={{ fontSize: 15, fontWeight: '500', marginLeft: 3, marginTop: 30 }}>Contact</Text>

                <View style={{ flexDirection: 'row', width: width / 1.1, justifyContent: 'space-between', alignSelf: 'center', }}>

                  {/* <View style={{width:'25%',alignItems:'center', justifyContent:'center'}}> */}

                  <TextInput allowFontScaling={false} onChangeText={name => this.setState({ name })} style={{ marginTop: 10, width: '25%', height: 40, backgroundColor: '#EEEEF6', paddingLeft: 20, borderRadius: 6, alignSelf: 'center', color: 'black', }} placeholder="+224" placeholderTextColor='gray' />
                ...
                <View style={{ width: width / 1.1, marginTop: 20, height: 50, alignSelf: 'center' }} >
                  <Text style={{ fontSize: 15, fontWeight: '500' }}>Your Clinic address</Text>

                  <TextInput allowFontScaling={false} onChangeText={name => this.setState({ name })} style={{ marginTop: 10, width: width / 1.1, height: 40, backgroundColor: '#EEEEF6', paddingLeft: 20, borderRadius: 6, alignSelf: 'center', color: 'black', }} placeholder="1010 Sainte Catherine, Montreal" placeholderTextColor='gray' />
                ...
                <Text style={{ fontSize: 15, color: '#3434FB', width: '95%', fontWeight: 'bold', marginTop: 20, }} >Add another location </Text>
            ...
            <ProgressStep onSubmit={() => this.submit()} label="" previousBtnStyle={styles.previous_button} previousBtnTextStyle={styles.previous_text} nextBtnStyle={styles.next_button} nextBtnTextStyle={styles.next_text}>
              ...
              <View style={{ width: width / 1.1, alignSelf: 'center', borderRadius: 10, marginTop: 10 }}>
                <Text style={{ color: 'black', marginBottom: 15, fontSize: 25, fontWeight: '600' }}>Location & Timings</Text>
                <Text style={{ color: 'black', marginTop: 20, fontSize: 15, fontWeight: '600', }}>Practice Location</Text>





                <View style={{ flexDirection: 'row', width: width / 1.1, alignSelf: 'center', justifyContent: 'space-between' }}>

                  <Text style={{ color: '#2E2E37', marginTop: 5, fontSize: 15, fontWeight: '400' }}>1010 Sainte Catherine, Montreal</Text>
                ...
                <Text style={{ color: '#2E2E37', marginTop: 30, fontSize: 17, fontWeight: '600' }}>Days</Text>
                ...
                <Text style={{ color: '#2E2E37', marginTop: 20, fontSize: 17, fontWeight: '600' }}>Session 1</Text>
                ...
                <Text style={{ color: '#2E2E37', marginTop: 20, fontSize: 17, fontWeight: '600' }}>Session 2</Text>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10 }}>
                  ...
                  <Icon name="plus" type="Entypo" style={{ color: "gray", fontSize: 30, color: '#3085F4' }} />
                  <Text style={{ color: '#3085F4', fontSize: 16, fontWeight: '600' }}>ADD TIMING</Text>

                </View>


                <Text style={{ color: 'black', marginTop: 15, fontSize: 14, fontWeight: '600', marginLeft: 10 }}>Consultation fees</Text>



                <View style={{ backgroundColor: '#EEEEF6', height: 40, flexDirection: 'row', alignItems: 'center', borderRadius: 5, marginTop: 7, width: '95%', alignSelf: 'center', marginBottom: 40 }}>

                  <Text style={{ marginLeft: 15 }}>GNF</Text>
                  <Text style={{ color: 'lightgray', marginLeft: 10 }}>|</Text>
                  <Text style={{ marginLeft: 10 }}>100 000</Text>
                </View>
