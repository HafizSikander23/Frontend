        ...
        return (
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{ paddingHorizontal: 15, alignItems: 'center', justifyContent: 'center', paddingVertical: 13, shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5, backgroundColor: '#EEEEF6' }}>
                    ...
                    <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', textAlign: 'center' }}>My Consultations</Text>
                        ...
                        {this.state.check_design == 'pending' &&
                            ...
                            <TouchableOpacity activeOpacity={0.8}
                                ...
                                <View style={{ marginLeft: 10, width: '77%', }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
                                        <View>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                                <Icon name="questioncircle" type="AntDesign" style={{ color: "#FF8651", fontSize: 16 }} />


                                                <Text style={{ color: '#FF8651', fontSize: 12, fontWeight: 'bold' }}>  Feb 5, 2022, 7:30 PM (Pending) </Text>



                                            </View>
                                            <Text style={{ color: 'black', fontSize: 14, fontWeight: '600', marginTop: 5 }} numberOfLines={1} ellipsizeMode="tail">Maxime belanger</Text>
                                            <Text style={{ color: 'black', fontSize: 12, fontWeight: '400' }}>Visit Reason: Ilness</Text>

                                            <View style={{ width: 90, height: 20, backgroundColor: '#2C64F4', borderRadius: 15, justifyContent: 'center', alignItems: 'center', marginTop: 10 }}>
                                                <Text style={{ color: 'white', fontSize: 12, fontWeight: 'bold' }}>View details</Text>
                                            </View>
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, width: '80%' }}>
                                        <TouchableOpacity activeOpacity={0.8}
                                            style={{ width: '47%', paddingVertical: 7, justifyContent: 'center', alignItems: 'center', borderRadius: 8, backgroundColor: '#F7F2FC', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 3 }}>
                                            <Text style={{ color: '#8F49DE', fontWeight: 'bold' }}>Reject</Text>
                                        </TouchableOpacity>

                                        <TouchableOpacity activeOpacity={0.8}
                                            style={{ width: '47%', paddingVertical: 7, justifyContent: 'center', alignItems: 'center', borderRadius: 8, backgroundColor: '#8F49DE', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 3 }}>
                                ...
                                <TouchableOpacity activeOpacity={0.8}
                                    ...
                                    <View style={{ marginLeft: 10, width: '77%' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
                                            <View>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                                    <Icon name="calendar-clock" type="MaterialCommunityIcons" style={{ color: "#8F49DE", fontSize: 18 }} />
                                                ...
                                                <Text style={{ color: 'black', fontSize: 17, fontWeight: '600', marginTop: 5 }} numberOfLines={1} ellipsizeMode="tail">Alexandre benoit</Text>
                                                <Text style={{ color: 'black', fontSize: 14, fontWeight: '400', marginTop: 8 }}>Visit Reason: Ilness</Text>
                                        ...
                                        <TouchableOpacity activeOpacity={0.8} onPress={() => Actions.patient_site_appointment_detai({ status: 'active' })}
                                            style={{ paddingHorizontal: 10, marginTop: 5, paddingVertical: 8, backgroundColor: '#8F49DE', alignItems: 'center', justifyContent: 'center', borderRadius: 6, marginTop: 10 }}>
                                ...
                                <TouchableOpacity activeOpacity={0.8}
                                    ...
                                    <View style={{ marginLeft: 10, width: '77%' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
                                            <View>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                                    <Icon name="calendar-clock" type="MaterialCommunityIcons" style={{ color: "#159AB3", fontSize: 18 }} />


                                                    <Text style={{ color: '#159AB3', fontSize: 14, fontWeight: 'bold' }}>  Feb 5, 2022, 7:30 PM</Text>



                                                </View>
                                                <Text style={{ color: 'black', fontSize: 17, fontWeight: '600', marginTop: 5 }} numberOfLines={1} ellipsizeMode="tail">Gibert Fosto</Text>
                                                <Text style={{ color: 'black', fontSize: 14, fontWeight: '400', marginTop: 8 }}>Visit Reason: Gynecology Problem</Text>
                                        ...
                                        <View style={{ paddingHorizontal: 10, marginTop: 5, paddingVertical: 8, backgroundColor: '#159AB3', alignItems: 'center', justifyContent: 'center', borderRadius: 6, marginTop: 10 }}>
                                            <Text style={{ color: 'white' }}>View Details</Text>
                                        </View>
                                ...
                                <TouchableOpacity activeOpacity={0.8}
                                    ...
                                    <View style={{ marginLeft: 10, width: '77%' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
                                            <View>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                                    <Icon name="calendar-check" type="FontAwesome5" style={{ color: "#8F49DE", fontSize: 16 }} />
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, width: '100%' }}>
                                            <TouchableOpacity activeOpacity={0.8}
                                                style={{ width: '93%', paddingVertical: 10, justifyContent: 'center', alignItems: 'center', borderRadius: 8, backgroundColor: '#F7F2FC', shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 3 }}>
                                                <Text style={{ color: '#8F49DE', fontWeight: 'bold', fontSize: 15 }}>View Reports</Text>
                                            </TouchableOpacity>
                                ...
                                <TouchableOpacity activeOpacity={0.8}
                                    ...
                                    <View style={{ marginLeft: 10, width: '77%' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
                                            <View>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                                    <Icon name="calendar-check" type="FontAwesome5" style={{ color: "#159AB3", fontSize: 16 }} />
                                ...
                                <TouchableOpacity activeOpacity={0.8}
                                    ...
                                    <View style={{ marginLeft: 10, width: '77%' }}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
                                            <View>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                                                    <Icon name="calendar-clock" type="MaterialCommunityIcons" style={{ color: "#D91F11", fontSize: 18 }} />


                                                    <Text style={{ color: '#D91F11', fontSize: 14, fontWeight: 'bold' }}>  Feb 5, 2022, 7:30 PM</Text>
