  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <Text style={{ fontSize: 16, color: 'gray', width: '95%', marginLeft: 15 }} numberOfLines={3} >Our team is verifying your profile details which you have provided.kindly give us 7 working days to verify the information</Text>
        ...
        <TouchableOpacity onPress={() => Actions.login1()} style={{
          width: '50%',
          height: 43,
          borderRadius: 10,
