  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={{ width: width / 1.1, paddingVertical: 10, alignSelf: 'center', borderRadius: 10, backgroundColor: '#EAF3FE', marginTop: 10 }}>

          <Text style={{ color: 'black', marginBottom: 5, marginLeft: 20, marginTop: 20, fontSize: 20, fontWeight: '500' }}>Step B: Profile Varification</Text>
          <Text style={{ fontSize: 17, color: 'gray', width: '95%', marginLeft: 20 }} numberOfLines={3} >Pharmacy identity proof, registration proof, establishment ownership proof etc.</Text>

          <View style={{ flexDirection: 'row', width: width / 1.1, alignSelf: 'center', marginTop: 15 }}>
            <TouchableOpacity onPress={() => Actions.Vendor_Profile_Verification()} style={{
              width: '50%',
              height: 43,
              borderRadius: 10,
        ...
        <Text style={{ color: 'black', marginBottom: 5, marginLeft: 30, marginTop: 20, fontSize: 20, fontWeight: '500' }}>Step C: Start getting Patients</Text>
        <Text style={{ fontSize: 17, color: 'gray', width: '95%', marginLeft: 30 }} numberOfLines={3} >Location ,Timing, Fees</Text>
