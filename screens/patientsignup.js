      ...
      <View style={{ flex: 1, backgroundColor: 'red' }}>
        ...
        <View style={{ backgroundColor: '#EEEEF6', height: 60, paddingTop: 20 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: width / 1.1, alignSelf: 'center' }}>
            ...
            <Text style={{ fontWeight: '500', fontSize: 20, }}>Signup</Text>
        ...
        <ScrollView>
          ...
          <View style={{ width: width / 1.1, marginTop: 30, height: 50, alignSelf: 'center' }} >
            <Text style={{ fontSize: 12, fontWeight: 'bold' }}>Birthdate</Text>

            <TextInput allowFontScaling={false} onChangeText={name => this.setState({ name })} style={{ marginTop: 10, width: width / 1.1, height: 40, backgroundColor: '#EEEEF6', paddingLeft: 20, borderRadius: 6, alignSelf: 'center', color: 'black', }} placeholder="Enter your birthdate" placeholderTextColor='gray' />
            {/* <Icon name="email" type="MaterialCommunityIcons" style={{ color: "#235fa9", fontSize: 24,position:'absolute',left:10,top:20 }} /> */}
          ...
          <Text style={{ textAlign: 'center', fontSize: 13, marginTop: 40 }}>Or signup with</Text>

          <View style={{ backgroundColor: '#9B56EC', width: width / 1.1, height: 40, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: 20, borderRadius: 8 }}>
          ...
          <View style={{ flexDirection: 'row', alignSelf: 'center', marginTop: 20, marginBottom: 20 }}>
            ...
            <Text style={{ color: '#9B56EC', fontSize: 14, fontWeight: 'bold' }}> Login</Text>
