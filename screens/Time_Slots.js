  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <Text style={{ fontSize: 17, fontWeight: '500', textAlign: 'center', marginTop: 25 }}>Set your availability to start attending patients</Text>


        <View style={{ width: width / 1.1, alignSelf: 'center', paddingTop: 35, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <View style={{ width: width / 1.1, alignSelf: 'center', paddingTop: 35, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ color: 'black', fontSize: 17, fontWeight: '600' }}>Saturday</Text>
          <ToggleSwitch
            isOn={this.state.isOn2}
            onColor="#8F49DE"
            offColor="#EEEEEE"
        ...
        <View style={{ width: width / 1.1, alignSelf: 'center', paddingTop: 35, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          <Text style={{ color: 'black', fontSize: 17, fontWeight: '600' }}>Sunday</Text>
          <ToggleSwitch
            isOn={this.state.isOn2}
            onColor="#8F49DE"
            offColor="#EEEEEE"
