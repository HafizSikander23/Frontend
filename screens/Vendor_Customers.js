      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={{ backgroundColor: '#EEEEF6', height: 60, paddingTop: 20 }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: width / 1.1, alignSelf: 'center' }}>
            ...
            <Text style={{ fontWeight: '500', fontSize: 20, }}>Patients</Text>
          ...
          <View style={{ marginLeft: 10, width: '77%', }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingRight: 10 }}>
              <View>
                ...
                <View style={{ backgroundColor: 'white', height: 30, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', borderRadius: 8, borderColor: '#9B56EC', borderWidth: 1, width: 110, marginTop: 30 }}>
                  <Text style={{ color: '#9B56EC', fontSize: 15, }}>View details</Text>
                </View>
        ...
        <TouchableOpacity onPress={() => Actions.Add_Patient()}
          style={{ backgroundColor: '#9B56EC', width: width / 1.1, height: 40, flexDirection: 'row', alignSelf: 'center', alignItems: 'center', justifyContent: 'center', borderRadius: 8, marginTop: 20 }}>
          <Icon name="plus" type="Entypo" style={{ color: 'white', marginRight: 3.5, fontSize: 20, }} />

          <Text style={{ color: 'white', fontSize: 15, fontWeight: '600' }}>Add a customer</Text>
        </TouchableOpacity>
