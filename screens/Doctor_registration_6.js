    ...
    return (
      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={{ width: width / 1.1, paddingVertical: 10, alignSelf: 'center', borderRadius: 10, backgroundColor: '#EAF3FE', marginTop: 10 }}>
          ...
          <Text style={{ fontSize: 17, color: 'gray', width: '95%', marginLeft: 20 }} numberOfLines={3} >Doctor identity proof, registration proof, establishment ownership proof etc.</Text>

          <View style={{ flexDirection: 'row', width: '90%', alignSelf: 'center', marginTop: 15 }}>
            <TouchableOpacity onPress={() => Actions.testing()} style={{
              width: '50%',
              height: 43,
              borderRadius: 10,
        ...
        <Text style={{ color: 'black', marginBottom: 5, marginLeft: 30, marginTop: 20, fontSize: 20, fontWeight: '500' }}>Step C: Starting getting Patients</Text>
