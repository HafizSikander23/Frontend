    ...
    return (
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={{ width: width / 1.1, marginTop: 20, alignSelf: 'center' }} >
          <Text style={{ fontSize: 13, fontWeight: 'bold' }}>Email or Phone number</Text>
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={() => Actions.Vendor_Tab_Screen()} style={{ backgroundColor: '#9B56EC', width: width / 1.1, height: 40, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: 20, borderRadius: 8 }}>
        ...
        <View style={{ flexDirection: 'row', alignSelf: 'center', width: width / 1.6, justifyContent: 'space-between', marginTop: 40 }}>
          ...
          <View style={{ flexDirection: 'row', width: '47%', height: 39, borderColor: 'gray', borderWidth: 0.5, alignItems: 'center', justifyContent: 'center', borderRadius: 6 }}>
            ...
            <Text style={{ fontSize: 15, color: 'gray', fontWeight: '500', marginLeft: 7 }}>Laboratory</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', width: '47%', height: 39, borderColor: '#9B56EC', borderWidth: 1.5, alignItems: 'center', justifyContent: 'center', borderRadius: 6, backgroundColor: '#F7F2FC' }}>
            ...
            <Text style={{ fontSize: 15, color: '#9B56EC', fontWeight: '500', marginLeft: 7 }}>Pharmacy</Text>
          </View>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 130 }}>
          <Text style={{ textAlign: "center", fontSize: 15, fontWeight: '500', }}>Don’t have an account?</Text>
          <TouchableOpacity onPress={() => Actions.Vendor_SignUp()}>

            <Text style={{ color: '#9B56EC', textAlign: "center", fontSize: 17, fontWeight: '600', }}> Signup</Text>
