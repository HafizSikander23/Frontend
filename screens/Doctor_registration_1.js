  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: width / 1.1, paddingVertical: 10, alignSelf: 'center' }}>
        ...
        <View style={{ width: width / 1.05, paddingVertical: 10, alignSelf: 'center', backgroundColor: '#f0f6fc', borderRadius: 10 }}>
          ...
          <Text style={{ fontSize: 17, color: '#60606C', width: '95%', marginLeft: 15 }} numberOfLines={3} >Clinic's basic details, medical registration, education qualification, establishment details etc.
          </Text>
          ...
          <TouchableOpacity style={{
            ...
            <TouchableOpacity onPress={() => Actions.Basic_Detail()} >
        ...
        <Text style={{ fontSize: 16, color: '#60606C', width: '95%', marginLeft: 20, fontWeight: '400' }} numberOfLines={3} >Doctor identity proof, registration proof, establishment ownership proof etc.</Text>
        <Text style={{ color: '#2E2E37', marginBottom: 5, marginLeft: 20, marginTop: 30, fontSize: 17, fontWeight: '500' }}>Step C: Starting getting Patients</Text>
