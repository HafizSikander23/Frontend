  ...
  render() {
    return (
      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <ScrollView>
          <TouchableOpacity onPress={() => Actions.Edit_Profile()} style={{ width: width / 1.1, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 20, borderBottomWidth: 0.5, borderBottomColor: 'lightgray', paddingBottom: 15 }}>
          ...
          <TouchableOpacity onPress={() => Actions.My_Patient()} style={{ width: width / 1.1, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 20, borderBottomWidth: 0.5, borderBottomColor: 'lightgray', paddingBottom: 15 }}>


            <Icon name="group" type="FontAwesome" style={{ color: "#8F49DE", fontSize: 23, }} />

            <Text style={{ fontSize: 17, width: '80%' }}>My patients</Text>
          ...
          <TouchableOpacity onPress={() => Actions.Time_Slots()}
            ...
            <Text style={{ fontSize: 17, width: '80%' }}>Time Slots</Text>
          ...
          <TouchableOpacity onPress={() => Actions.Doctors()}
            ...
            <Icon name="doctor" type="Fontisto" style={{ color: "#8F49DE", fontSize: 23, }} />

            <Text style={{ fontSize: 17, width: '80%' }}>My doctors List</Text>
          ...
          <TouchableOpacity onPress={() => Actions.Doctors()}
            ...
            <Text style={{ fontSize: 17, width: '80%' }}>My clinics</Text>
          ...
          <TouchableOpacity onPress={() => Actions.articles()} style={{ width: width / 1.1, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 20, borderBottomWidth: 0.5, borderBottomColor: 'lightgray', paddingBottom: 15 }}>
          ...
          <TouchableOpacity style={{ width: width / 1.1, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 20, borderBottomWidth: 0.5, borderBottomColor: 'lightgray', paddingBottom: 15 }}>
            ...
            <Text style={{ fontSize: 17, width: '80%' }}>Payments</Text>
          ...
          <TouchableOpacity activeOpacity={0.8} onPress={() => this.RBSheet2.open()} style={{ width: width / 1.1, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginTop: 20, borderBottomWidth: 0.5, borderBottomColor: 'lightgray', paddingBottom: 15 }}>
