    ...
    return (
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <ScrollView>
          ...
          <TouchableOpacity activeOpacity={0.8} onPress={() => Actions.Verification_Screen()} style={{ backgroundColor: '#9B56EC', width: width / 1.1, height: 40, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: 40, borderRadius: 8 }}>
          ...
          <View style={{ flexDirection: 'row', alignSelf: 'center', marginTop: 30, marginBottom: 40, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <TouchableOpacity onPress={() => Actions.login1()}>
