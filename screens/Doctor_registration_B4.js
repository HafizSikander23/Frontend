    ...
    return (
      ...
      <View style={{ flex: 1, backgroundColor: 'white' }}>
        ...
        <View style={{ width: width / 1.1, paddingVertical: 10, alignSelf: 'center', borderRadius: 10, backgroundColor: '#EAF3FE', }}>
          ...
          <View style={{ flexDirection: 'row', width: '90%', alignSelf: 'center', marginTop: 15, justifyContet: 'space-between' }}>
            <TouchableOpacity onPress={() => Actions.getting_patients()} style={{
              width: '50%',
