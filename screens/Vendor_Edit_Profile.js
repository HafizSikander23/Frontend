    ...
    return (
      <View style={{ flex: 1, backgroundColor: 'white', paddingBottom: 50 }}>
        ...
        <ScrollView>
          ...
          <View style={{ width: width / 1.1, flexDirection: 'row', alignSelf: 'center', justifyContent: 'space-between', backgroundColor: '#FFE0DE', height: 40, alignItems: 'center', marginTop: 30, }}>
            <View style={{ width: '90%', alignSelf: 'center', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
              <Icon name="circle-o-notch" type="Fontisto" style={{ color: '#D91F11', fontSize: 20, marginLeft: 40 }} />

              <Text style={{ color: '#D91F11', fontSize: 15, width: '50%', marginLeft: 5, }}>85% Completed</Text>
          ...
          <View style={{ width: width / 1.1, marginTop: 70, height: 50, alignSelf: 'center' }} >
            <Text style={{ fontSize: 12, fontWeight: 'bold' }}>First Name</Text>

            <TextInput allowFontScaling={false} onChangeText={name => this.setState({ name })} style={{ marginTop: 10, width: width / 1.1, height: 40, backgroundColor: '#EEEEF6', paddingLeft: 20, borderRadius: 6, alignSelf: 'center', color: 'black', }} placeholder="John" placeholderTextColor='gray' />
          ...
          <View style={{ width: width / 1.1, marginTop: 30, height: 50, alignSelf: 'center' }} >
            ...
            <TextInput allowFontScaling={false} onChangeText={name => this.setState({ name })} style={{ marginTop: 10, width: width / 1.1, height: 40, backgroundColor: '#EEEEF6', paddingLeft: 20, borderRadius: 6, alignSelf: 'center', color: 'black', }} placeholder="Doe" placeholderTextColor='gray' />
          ...
          <Text style={{ fontSize: 12, fontWeight: 'bold', marginLeft: 19, marginTop: 30 }}>Contact</Text>
          ...
          <View style={{ width: width / 1.1, marginTop: 20, height: 50, alignSelf: 'center' }} >
            ...
            <TextInput allowFontScaling={false} onChangeText={name => this.setState({ name })} style={{ marginTop: 10, width: width / 1.1, height: 40, backgroundColor: '#EEEEF6', paddingLeft: 20, borderRadius: 6, alignSelf: 'center', color: 'black', }} placeholder="" placeholderTextColor='gray' />
          ...
          <TouchableOpacity onPress={() => Actions.Personal_Detail()} style={{ backgroundColor: '#9B56EC', width: width / 1.1, height: 40, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', borderRadius: 8, marginTop: 50 }}>
