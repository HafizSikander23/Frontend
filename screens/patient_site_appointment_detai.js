      ...
      <>
        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
          ...
          <ScrollView>
            ...
            <Text style={{ color: 'black', fontSize: 15, fontWeight: '600', paddingHorizontal: 15 }} numberOfLines={1} ellipsizeMode="tail">Location</Text>

            <Text style={{ color: 'black', fontWeight: '200', fontSize: 13, paddingHorizontal: 15 }}>Fortis Hospital, Washington Ave. Manchester, Kentucky 39495</Text>
            ...
            <View style={{ width: width, height: 1, backgroundColor: 'lightgray', marginVertical: 15 }}></View>

            <Text style={{ color: 'black', fontSize: 15, fontWeight: '600', paddingHorizontal: 15 }} numberOfLines={1} ellipsizeMode="tail">Uploaded documents</Text>
            ...
            <Text style={{ color: 'black', fontSize: 15, fontWeight: '600', paddingHorizontal: 15, marginTop: 20 }} numberOfLines={1} ellipsizeMode="tail">Booking details</Text>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, paddingHorizontal: 15 }}>
              <Text style={{ color: 'gray', fontWeight: '500', fontSize: 15 }}>Appointment fees:</Text>

              <Text style={{ color: 'gray', fontWeight: '600', fontSize: 15 }}> 100000 GNF</Text>
            </View>
            {this.props.status == 'active' &&
              <View>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, borderRadius: 8, marginTop: 20, paddingHorizontal: 15, width: width / 1.1, alignSelf: 'center', backgroundColor: '#EAF3FE', paddingVertical: 10 }}>
                  <Icon name="calendar" type="Entypo" style={{ color: "#186ADE", fontSize: 24 }} />


                  <Text style={{ color: '#186ADE', width: '80%', fontWeight: '600', fontSize: 15 }}> Reschedule</Text>
                  <Icon name="chevron-right" type="Entypo" style={{ color: "#186ADE", fontSize: 24 }} />

                </View>



                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, borderRadius: 8, marginTop: 20, paddingHorizontal: 15, width: width / 1.1, alignSelf: 'center', backgroundColor: '#FCF0F0', paddingVertical: 10 }}>
                  <Icon name="squared-cross" type="Entypo" style={{ color: "#D91F11", fontSize: 24 }} />


                  <Text style={{ color: '#D91F11', width: '80%', fontWeight: '600', fontSize: 15 }}> Cancel</Text>
                  <Icon name="chevron-right" type="Entypo" style={{ color: "#D91F11", fontSize: 24 }} />
            ...
            <View style={{ flexDirection: 'row', width: width / 1.1, alignSelf: 'center', marginTop: 15 }}>
              ...
              <Icon name="clock" type="EvilIcons" style={{ color: "EvilIcons", fontSize: 20 }} />

              <Text style={{ fontSize: 12 }}>In clinic Visit</Text>
            ...
            <View style={{ flexDirection: 'row', width: width / 1.1, alignSelf: 'center', marginTop: 5 }}>
              ...
              <Text style={{ color: '#9B56EC', fontSize: 13, fontWeight: '700', marginTop: 3 }}>Today, 5:30 PM</Text>

              <View style={{ flexDirection: 'row', width: 150, alignItems: 'center', justifyContent: 'center', backgroundColor: '#EEEEF6', marginLeft: 8 }}>
                <Icon name="filter" type="FontAwesome" style={{ color: "EvilIcons", fontSize: 20 }} />


                <Text style={{ color: 'black', fontSize: 13, marginLeft: 5, fontWeight: '400', }}>Starts in 1 minutes</Text>
            ...
            <View style={{ backgroundColor: '#9B56EC', width: width / 1.7, height: 40, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', marginTop: 20, borderRadius: 38 }}>
              <Text style={{ color: 'white', fontSize: 14, fontWeight: '500' }}>Attend Session at 5:30 PM</Text>
            </View>
