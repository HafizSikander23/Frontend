        ...
        fetch(api, {
          ...
          .then((response) => {
            ...
            if (hasRecord == "fail") {
              ...
              if (type == "audio") {
                Actions.pick_audio_call({ receiver: receiver_name, receiver_image: receiver_image, room: room, })
              }
              else {
                Actions.pick_video_call({ role: role, receiver: receiver_name, receiver_image: receiver_image, room: room, })
              }
            }
            //let len = hasRecord
          })
        ...
        .then((response) => {
          ...
          if (hasRecord == "fail") {
            ...
            if (type == "audio") {
              ...
              Actions.pick_call({ receiver: receiver_name, receiver_image: receiver_image, room: room, })
            }
          }
          //let len = hasRecord
        })
                ...
                {sender_id != this.state.id ? <View >
                  <View style={{ maxWidth: '80%', paddingHorizontal: 15, marginTop: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', }}>
                      <Image style={{ width: 30, height: 30, borderRadius: 100, alignSelf: 'flex-end', marginRight: 10, marginBottom: 10 }} source={require('../assets/Father.png')} />
                ...
                {sender_id != this.state.id ? <View >
                  <View style={{ maxWidth: '70%', alignSelf: 'flex-start', borderRadius: 15, padding: 2, backgroundColor: "white", marginLeft: 10, marginTop: 10, width: width / 2.3 }}>
                    <TouchableOpacity onPress={() => this.onClickImage(finalimage)} ><ImageLoad
                      ...
                      placeholderSource={require('../assets/Father.png')}
                ...
                {sender_id != this.state.id ? <View >
                  <View style={{ maxWidth: '70%', alignSelf: 'flex-start', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 5, backgroundColor: "lightgray", marginLeft: 10, marginTop: 10 }}>
                    <TouchableOpacity onPress={() => this.open_file(finalimage)} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '70%' }}>
                      <Icon name="file-pdf" type="FontAwesome5" style={{ fontSize: 30, color: '#595788', }} />
                  ...
                  <View>
                    <View style={{ maxWidth: '70%', alignSelf: 'flex-end', borderRadius: 6, paddingHorizontal: 10, paddingVertical: 5, backgroundColor: "#FE0000", marginRight: 10, marginTop: 10 }}>
                      <TouchableOpacity onPress={() => this.open_file(finalimage)} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '70%' }}>
                        <Icon name="file-pdf" type="FontAwesome5" color="white" style={{ fontSize: 30, color: 'white', }} />
    ...
    return (
      ...
      <>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ paddingHorizontal: 15, paddingVertical: 8, backgroundColor: "#EEEEF6", }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Icon name="arrowleft" type="AntDesign" onPress={() => Actions.pop()} style={{ color: 'black', fontSize: 26 }} />


              <Image style={styles.image} source={require('../assets/Father.png')} />
              ...
              <TouchableOpacity  >
                ...
                <Icon name="dots-three-vertical" type="Entypo" style={{ color: 'black', fontSize: 22, marginLeft: 10, marginRight: 5 }} />
              </TouchableOpacity>
              {/* } */}
            </View>
          ...
          {this.state.skalton == true ?
            ...
            <ScrollView ref={ref => { this.scrollView = ref }}
              ...
              <TouchableOpacity activeOpacity={0.8} style={{ alignItems: 'flex-end', paddingHorizontal: 15, marginTop: 15 }}>
                <View style={{ backgroundColor: '#8F49DE', borderTopLeftRadius: 18, borderBottomLeftRadius: 18, borderTopRightRadius: 18, paddingBottom: 5, paddingTop: 13, paddingHorizontal: 13, maxWidth: '80%' }}>
        ...
        >
          <View>
            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }} onPress={() => this.copyToClipboard()} >
              <Icon name="copy1" type="AntDesign" style={{ color: "black", fontSize: 25 }} />
            ...
            <View style={{ flexDirection: 'row', marginTop: 30, alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 13, width: '100%' }}>
              ...
              <TouchableOpacity onPress={() => this.uploadimage1()} activeOpacity={0.6}>
                <View style={{ flexDirection: 'column', marginLeft: 10, justifyContent: 'center', alignItems: 'center' }}>
                  <Icon name="images" type="Entypo" color="white" style={{ fontSize: 30, color: '#FE0000', }} />
              ...
              <TouchableOpacity onPress={() => this.Check_PlatForm()} activeOpacity={0.6}>
                <View style={{ flexDirection: 'column', marginLeft: 40, justifyContent: 'center', alignItems: 'center' }}>
                  <Icon name="camera" type="Entypo" color="white" style={{ fontSize: 30, color: '#FE0000', }} />
              ...
              <TouchableOpacity onPress={() => this.handleDocumentSelection()} activeOpacity={0.6}>
                <View style={{ flexDirection: 'column', marginLeft: 40, justifyContent: 'center', alignItems: 'center' }}>
                  <Icon name="file-pdf" type="FontAwesome5" color="white" style={{ fontSize: 30, color: '#FE0000', }} />
        ...
        <View style={{ position: 'absolute', bottom: 0, width: width }}>
          ...
          <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 15, borderTopWidth: 1, borderColor: 'lightgray', paddingVertical: 13, backgroundColor: 'white' }}>
            <View style={{ alignItems: 'center', width: '100%' }}>
              <TextInput value={this.state.message} style={{ width: '100%', height: 45, borderRadius: 48, paddingLeft: 10, backgroundColor: '#EEEEF6', color: 'black' }} placeholder="Message" placeholderTextColor='gray' underlineColorAndroid="transparent" onChangeText={(message) => this.setState({ message })} />
              <Icon onPress={() => this.RBSheet1.open()} name="send" type="Ionicons" style={{ color: "gray", fontSize: 18, position: 'absolute', right: 15, top: 12 }} />
              <Icon onPress={() => this.RBSheet1.open()} name="file" type="FontAwesome" style={{ color: "gray", fontSize: 18, position: 'absolute', right: 45, top: 12 }} />
        ...
        {this.state.spinner2 == true &&
          <View style={{ width: width / 1, height: height / 1, backgroundColor: 'rgba(2, 2, 2, 0.8)', position: 'absolute', justifyContent: 'center', alignItems: 'center' }}>
            <View style={{
